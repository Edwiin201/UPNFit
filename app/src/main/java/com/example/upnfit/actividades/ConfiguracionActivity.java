...
public class ConfiguracionActivity extends AppCompatActivity {
    ...
    Button btnmenuPerfil, btnmenuCuenta, btnmenuNotificaciones, btnmenuObjetivos;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnmenuNotificaciones = findViewById(R.id.btnmenuNotificaciones);
        ...
        // === Acción: abrir pantalla de Notificaciones ===
        btnmenuNotificaciones.setOnClickListener(v -> {
